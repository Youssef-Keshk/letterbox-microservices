...
public class UserRatingService {
    ...
    public UserRating getUserRating(@PathVariable("userId") String userId) {
        String ratingsUrl = "http://ratings-data-service/ratings/users/" + userId;
    ...
    public String addRating(Rating rating) {
        String addUrl = "http://ratings-data-service/ratings/add";
        ResponseEntity<String> response = restTemplate.postForEntity(addUrl, rating, String.class);
        return response.getBody();
    }

    public String addRatingFallback(Rating rating) {
        return "Service unavailable. Your rating for movie " + rating.getMovieId() + " could not be saved at this time.";
    }
}